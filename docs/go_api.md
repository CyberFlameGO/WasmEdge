...
```bash
wget -qO- https://raw.githubusercontent.com/WasmEdge/WasmEdge/master/utils/install.sh | bash -s -- -e tf,image -v 0.9.0-rc.4
```
...
1. Store
    ...
    In this case, developers should guarantee the life cycle of the `Store` object.
